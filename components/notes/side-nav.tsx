...
import { EmptyPageItemsListState } from "@/components/notes/empty";
import PageItemsListServer from "@/components/notes/page-items-list.server";
          ...
          <SidebarGroupContent className="overflow-hidden">
            <ScrollArea className="h-[calc(100vh-185px)] px-3">
              <SidebarMenu className="space-y-1">
                <Suspense fallback={<EmptyPageItemsListState />}>
                  <PageItemsListServer />
                </Suspense>
              </SidebarMenu>
            </ScrollArea>
