    ...
    return (
        ...
        >
            <div 
                ...
                justify-center text-2xl sm:text-3xl md:text-4xl w-fit group-hover:scale-110"
            >
                {Icon && <Icon className="w-[1em] h-[1em] text-[#A590DB] group-hover:text-white transition duration-200"/>}
            </div>
